...
var Class = (function() {
  ...
  **/
  ...
  function create() {
    ...
    _.extend(klass, { addMethods: addMethods });
  ...
  function addMethods(source) {
    ...
    for (var i = 0, length = properties.length; i < length; i++) {
      ...
      if (ancestor && _.isFunction(value) &&
        ...
        var method = value;
        var Self = this;
        value = _.wrap( ((function(m) {
          return function() { return ancestor[m].apply(Self, arguments); };
        })(property)), method);

        value.valueOf = _.bind(method.valueOf, method);
        value.toString = _.bind(method.toString, method);
      }
 ...
 *      //-> ['foo', 'bar']
 *
 *      argumentNames(Prototype.emptyFunction);
 *      //-> []
**/
