...
require.modules["/node_modules/dormouse/package.json"] = function () {
    ...
    (function () {
        module.exports = {"name":"dormouse","version":"0.0.1","description":"Javascript API for Dormouse","main":"lib/assembler","homepage":"http://dormou.se","keywords":["crowdsourcing"],"repository":{"type":"git","url":"http://github.com/zahanm/node-dormouse.git"},"dependencies":{"underscore":"*","async":"*","ahr2":"2.x"},"devDependencies":{"coffee-script":"*","browserify":"*"}};
    }).call(module.exports);
...
require.modules["/node_modules/dormouse/lib/connection.coffee"] = function () {
    ...
    (function () {
        (function() {
  var API_KEY, Connection, DM_URL, appendOptions, async, libutils, node_url, parseResponse, path, _;
  path = require('path');
  async = require('async');
  ...
  */
  ...
  appendOptions = function(url, options) {
    var urlObj;
